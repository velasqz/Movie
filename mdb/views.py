...
from mdb.api.serializers import MovieSerializer
from mdb.forms import UserForm, MoviesForm, RatingMoviesForm, UserTokenForm, QueryMovieForm
...
# class MovieRaterUpdateView(UpdateView)
#     ser